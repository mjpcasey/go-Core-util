...
func TestMarshalUnmarshalRequestHeader(t *testing.T) {
	v := RequestHeader{}
...
func BenchmarkMarshalMsgRequestHeader(b *testing.B) {
	v := RequestHeader{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkUnmarshalRequestHeader(b *testing.B) {
	v := RequestHeader{}
...
func BenchmarkDecodeRequestHeader(b *testing.B) {
	v := RequestHeader{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
